...
country which you want to download the map of. It also has several levels 
resolution.

You can choose the country at [this](http://www.gadm.org/country) page. 
Also the type of the file can be chose. This file is for Turkey and the format
is `R (SpatialPolygonsDataFrame)`. When it is selected, there are three levels
to select from. This file is for `level 2`. Direct link for this file as of 
